                    ...
                    {packagesData.map((pkg) => (
                      ...
                      >
                        <div className='flex flex-col gap-2'>
                          <span className='text-xs text-muted-foreground'>/{pkg.namespace}</span>
                    ...
                    {namespacesSorted.map((ns) => (
                      <div key={`${ns.namespace}-${ns.hash}`} className='rounded-md border p-3'>
                        <div className='flex flex-col gap-2'>
                          ...
                          <span className='text-xs text-muted-foreground'>Block #{ns.blockHeight}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                    ...
                    {proposalsShown.map((p) => (
                      <div key={p.id} className='rounded-md border p-3'>
                        <div className='flex flex-col gap-2'>
                          ...
                          <span className='break-words text-sm'>{p.path}</span>
