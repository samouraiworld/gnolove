export const TUTORIAL_VIDEOS = [
  ...
  {
    src: 'https://www.youtube.com/embed/R5t1GmBRUVk?si=3WtMaeFAH_Kg2crq',
    title: 'Register your User Space - Gno land Education Tutorial',
  },
  {
    src: 'https://www.youtube.com/embed/B7bSreCwIls?si=A-OeUCuh6CXXLT9i',
    title: 'Deploying Gno Packages - Gno Land Education Tutorial',
  },
  {
