...
export type Issue = { id: string; title: string; url: string; createdAt: string; labels: Label[] };
export type PullRequest = { id: string; title: string; url: string; createdAt: string; labels: Label[] };
